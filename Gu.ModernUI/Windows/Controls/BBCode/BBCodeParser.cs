namespace Gu.ModernUI.Windows.Controls.BBCode
{
    using System;
        ...
        private void Parse(Span span)
        {
            ...
            while (true) {
                ...
                if (token.TokenType == BBCodeLexer.TokenStartTag) {
                    ...
                    throw new ParseException(Properties.Resources.UnexpectedToken);
                }
                else if (token.TokenType == BBCodeLexer.TokenEnd) {
                    break;
                }
                else {
                    throw new ParseException(Properties.Resources.UnknownTokenType);
                }
            }
        }
